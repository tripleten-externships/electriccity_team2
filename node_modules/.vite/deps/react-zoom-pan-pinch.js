...
var Context = import_react.createContext(null);
var getContent = function(children, ctx) {
	if (typeof children === "function") return children(ctx);
	return children;
};
var TransformWrapper = import_react.forwardRef(function(props, ref) {
...
var KeepScale = import_react.forwardRef(function(props, ref) {
...
var useResize = function(ref, onResize, dependencies) {
	...
	(0, import_react.useLayoutEffect)(function() {
		...
		if (ref) {
			...
			(_a = resizeObserverRef.current) === null || _a === void 0 || _a.observe(ref);
		}
		return function() {
			var _a;
			didUnmount.current = true;
			if (ref) (_a = resizeObserverRef.current) === null || _a === void 0 || _a.unobserve(ref);
		};
...
var MiniMap = function(_a) {
	...
	var transformMiniMap = function() {
		...
		if (previewRef.current) {
			...
			var previewScale = computeMiniMapScale() * (1 / instance.state.scale);
	...
	(0, import_react.useEffect)(function() {
		...
		var setDown = function(e) {
			var _a;
			if (((_a = mainRef.current) === null || _a === void 0 ? void 0 : _a.contains(e.target)) || e.target === mainRef.current) {
				move(e);
				setIsDown(true);
			}
		};
	...
	return (0, import_jsx_runtime.jsxs)("div", __assign({}, rest, {
		ref: mainRef,
		style: wrapperStyle,
		className: "rzpp-mini-map ".concat(rest.className || "").trim()
	}, { children: [(0, import_jsx_runtime.jsx)("div", __assign({
		style: { pointerEvents: "none" },
		ref: wrapperRef,
		className: "rzpp-minimap-wrapper ".concat(wrapperClassName || "").trim()
	}, { children })), (0, import_jsx_runtime.jsx)("div", {
		className: "rzpp-minimap-preview ".concat(previewClassName || "").trim(),
		ref: previewRef,
		style: __assign(__assign(__assign({}, previewStyles), { borderColor }), previewStyle)
	})] }));
};
...
var TransformComponent = function(_a) {
	...
	return (0, import_jsx_runtime.jsxs)("div", __assign({}, wrapperProps, {
		ref: wrapperRef,
		className: "".concat(baseClasses.wrapperClass, " ").concat(styles.wrapper, " ").concat(wrapperClass),
		style: wrapperStyle
	}, { children: [infinite && (0, import_jsx_runtime.jsx)("div", {
		ref: gridRef,
		className: styles.infiniteGrid,
		"aria-hidden": true
	}), (0, import_jsx_runtime.jsx)("div", __assign({}, contentProps, {
		ref: contentRef,
...
var Virtualize = import_react.forwardRef(function(_a, ref) {
	...
	if (!visible) return placeholder ? (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: placeholder }) : null;
	return (0, import_jsx_runtime.jsx)("div", __assign({
		ref,
		className,
		style
	}, { children }));
...
var useTransformContext = function() {
	...
	if (!libraryContext) throw new Error("Transform context must be placed inside TransformWrapper");
	return libraryContext;
};
var useControls = function() {
	return getControls(useTransformContext());
};
var useTransformInit = function(callback) {
	...
	(0, import_react.useEffect)(function() {
		var unmountCallback;
		var unmount;
		if (libraryContext.contentComponent && libraryContext.wrapperComponent) unmountCallback = callback(getState(libraryContext));
		else unmount = libraryContext.onInit(function(ref) {
			unmountCallback = callback(getState(ref.instance));
		});
		return function() {
			unmount === null || unmount === void 0 || unmount();
			unmountCallback === null || unmountCallback === void 0 || unmountCallback();
		};
	}, []);
};
...
function useTransformComponent(callback) {
	...
	(0, import_react.useEffect)(function() {
		var mounted = true;
		var unmount = libraryContext.onChange(function(ref) {
			if (mounted) setTransformRender(callback(getState(ref.instance)));
		});
		return function() {
			unmount();
			mounted = false;
...
//#endregion
export { Context, DeviceType, KeepScale, MiniMap, TransformComponent, TransformWrapper, Virtualize, getCenterPosition, getMatrixTransformStyles, getTransformStyles, roundScaleForTransform, useControls, useTransformComponent, useTransformContext, useTransformEffect, useTransformInit };
